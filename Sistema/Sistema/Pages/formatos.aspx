<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/master.Master" AutoEventWireup="true" CodeBehind="formatos.aspx.cs" Inherits="Sistema.Pages.formatos" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
       <h5 class="card-header">Crear un Formato</h5>
 ...
 <div class="form-group">
 <label for="inputEmail">Ingrese la Extensión</label>
 <br />
 <asp:TextBox ID="cextension"  runat="server" ClientIDMode="Static" CssClass="form-control"/>
</div>
