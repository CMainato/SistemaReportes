<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/master.Master" AutoEventWireup="true" CodeBehind="menus.aspx.cs" Inherits="Sistema.Pages.menus" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
       <h5 class="card-header">Crear Menu</h5>
 ...
 <asp:TextBox ID="cdescripcion"  runat="server" ClientIDMode="Static" CssClass="form-control"/>
          ...
          <div class="form-group">
 <label for="inputEmail">Ingrese Titulo Menu</label>
 <br />
 <asp:TextBox ID="cmenu"  runat="server" ClientIDMode="Static" CssClass="form-control"/>
</div>
