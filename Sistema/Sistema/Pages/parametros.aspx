<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/master.Master" AutoEventWireup="true" CodeBehind="parametros.aspx.cs" Inherits="Sistema.Pages.parametros" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
       <h5 class="card-header">Crear Parametros</h5>

 <br />
 <div class="form-group">
 <label for="inputEmail">Ingrese Nombre del Parametro</label>
 <br />
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
                                  ...
                                  <h5 class="card-header">Parametros</h5>
                                <div class="card-body">
